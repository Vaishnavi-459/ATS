...
public class OverallFeedBackServiceImpl implements OverallFeedbackService {
	...
	public List<OverallFeedback> getAllFeedbacks() {
		List<OverallFeedback> list = (List<OverallFeedback>) overallfeedbackRepository.findAll();
		return list;
	}

	/*
	 * TODO: Get Candiadate By keyword
	 */
	public List<OverallFeedback> getByKeyword(String keyword) {
		return overallfeedbackRepository.findByKeyword(keyword);
	}
