...
public class Feedback1ServiceImpl implements Feedback1Service {
	...
	public List<Feedback1> getAllFeedbacks() {
		List<Feedback1> list = (List<Feedback1>) feedback1Repository.findAll();
		return list;
	}

	/*
	 * TODO: Get Candidate By keyword
	 */
	public List<Feedback1> getByKeyword(String keyword) {
		return feedback1Repository.findByKeyword(keyword);
	}
}
